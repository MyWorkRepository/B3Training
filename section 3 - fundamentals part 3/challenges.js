...
// Hints:
// Test To calculate average of 3 values, add them all together and divide by 3
// Test To check if number A is at least double number B, check for A >= 2 * B.
